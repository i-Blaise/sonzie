...
<head>
    ...
    <title>Sonzie.Online Admin</title>
    ...
    <div class="hero-wrapper">
        <div class="left-inner">
            <div class="left-inner__wrapper">
                <img src="images/sonzie_logo.png" alt="sonzie-logo" width="200" height="200">
                <!-- <h2 class="left-header">Sonzie</h2> -->
                <P class="left-text">Admin Portal for Sonzie.online</P>
            </div>
